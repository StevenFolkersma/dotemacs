...
(defun nano-theme--basics ()
  ...
  (set-face 'region                                   'nano-face-region)
...
(defun nano-theme--flyspell ()
  ...
  (with-eval-after-load 'flyspell
    ;(set-face 'flyspell-duplicate                     'nano-face-default)
    ;(set-face 'flyspell-incorrect                     'nano-face-default)
...
(defun nano-theme--org ()
  ...
  (with-eval-after-load 'org
    ...
    (set-face 'org-block-begin-line                    'hl-line)
    (set-face 'org-block-end-line                      'hl-line)
    (unless (version< emacs-version "27.0")
    ...
    (set-face 'org-document-title                      'nano-face-strong)
...
+                                                      nano-face-strong))
    ...
    (set-face 'org-todo                              'nano-face-header-salient)
